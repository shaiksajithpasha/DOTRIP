...
class VendorLocalCharge(Base):
    __tablename__ = "vendor_local_charges"
    __table_args__ = (
        UniqueConstraint("vendorId", "vehicleTypeId", "rangeKey", name="uq_vendor_local_charge_range"),
        Index("ix_vendor_local_charge_vendor_vehicle", "vendorId", "vehicleTypeId"),
    )
